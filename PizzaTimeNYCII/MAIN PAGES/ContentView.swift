...
struct ContentView: View {
    ...
    enum pageView : Int, CaseIterable {
        case home = 0
        case list = 1
        case map = 2
        case closest = 3
    ...
    func openPizzaPage(_ page: pageView ) {
        ...
        playAudioSoundForPage(page)
        // TODO: open correct page
    }
    func playAudioSoundForPage(_ page: pageView ) {
        let audioFileName: [pageView: String] = [
            .list: "adventureTimePizza",
            .map: "rickBestPizza",
            .closest: "krustyKrabPizza",
            .feedback: "annoyedRick",
            .add: "excellent",
            .about: "ATHFPizzaTime"
        ]
        
        var soundIdRing:SystemSoundID = 0
        let soundUrl = Bundle.main.path(forResource: audioFileName[page], ofType: "m4a")
        print("Playing sound \(String(describing: audioFileName[page])) for page \(page)")
